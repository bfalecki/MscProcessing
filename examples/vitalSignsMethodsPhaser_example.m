...
rc.setTfAnalysisOutput("default"); % "default" / "predicted" 
...
for k = 1:length(tfAnalyzables)
    ...
    "JumpPenalty",0.1, ...
    "SelectMethod","middle", ... "lowest" / "first" / "nearest" / "middle"
...
custom_suffix = sprintf("dist%s_synchr%d_pred%d_ridge-%s_peaks-%s", ...
    distLog,synchrosqueezingApplied,predictionApplied,ridgeMethod,peaksMethod);

% prefix
baseName = "rec_04-Dec-2025";

outPathMat = makeOutputFilename(baseName, custom_suffix, outDir, "extension",".mat");
outPathJson = makeOutputFilename(baseName, custom_suffix, outDir,"extension",".json");
